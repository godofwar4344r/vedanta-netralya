...
const About: React.FC = () => {
  ...
  const defaultTimeline = [
    { id: 'h1', year: '2003', title: 'Foundation', desc: 'Established our primary superspecialty clinic in Haldwani with dedicated outpatient care.' },
    { id: 'h2', year: '2010', title: 'Refractive Suite', desc: 'Launched advanced laser vision correction and LASIK capabilities.' },
    { id: 'h3', year: '2018', title: 'Robotic Surgery', desc: 'Acquired Carl Zeiss and Alcon FLACS laser surgery suites.' },
        ...
        <EditableContainer id="about-header" className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-24">
          <div className="lg:col-span-6">
            ...
            <h1 className="section-text text-brand-navy mb-8">
              <EditableText id="about-title-1">Excellence in Ophthalmic Care</EditableText> <span className="italic font-light text-brand-teal" style={{ fontFamily: "'General Sans', sans-serif" }}>
                <EditableText id="about-title-2">Since 2003.</EditableText>
              </span>
            </h1>
