...
import { CheckCircle2, ArrowUpRight, Search, Sparkles, Shield, User, AlertTriangle, ShieldAlert } from 'lucide-react';
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-brand-navy/85 via-transparent to-transparent p-8 flex items-end pointer-events-none">
              <div>
                <span className="text-[10px] text-brand-teal tracking-[0.3em] font-black uppercase">
                  <EditableText id="optical-visual-title">Vedanta Optical</EditableText>
                </span>
                <p className="text-cream text-lg font-merriweather font-bold mt-1">
                  <EditableText id="optical-visual-desc">Comprehensive dispensing of premium lenses, blue-cut filters, and designer frames.</EditableText>
                </p>
              </div>
            </div>
          </div>
