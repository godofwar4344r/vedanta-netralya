              ...
              <AnimatePresence>
                {isMoreDropdownOpen && (
                  ...
                  >
                    ...
                    <Link to="/doctors" className={`hover:text-brand-teal transition-colors py-1 flex items-center justify-between ${location.pathname === '/doctors' || location.pathname === '/team' ? 'text-brand-teal font-black' : 'text-cream/90'}`}>
                      <span>Our Doctors & Team</span>
                      {(location.pathname === '/doctors' || location.pathname === '/team') && <span className="w-1.5 h-1.5 rounded-full bg-brand-teal" />}
                    </Link>
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="flex flex-col gap-4 font-merriweather text-sm tracking-wider uppercase font-bold text-cream/90">
              ...
              <Link to="/doctors" onClick={() => setIsMobileMenuOpen(false)} className={`pl-4 text-xs ${location.pathname === '/doctors' || location.pathname === '/team' ? 'text-brand-teal font-black' : ''}`}>Our Doctors & Team</Link>
