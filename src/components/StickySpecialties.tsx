...
const SPECS: Spec[] = [
  ...
  { num: '02', tag: 'Vitreoretinal Specialty', title: 'Retina and Vitreous', desc: 'Sutureless micro-incision vitrectomy surgery for diabetic retinopathy, macular holes, and retinal detachment.', stat: '6,000+', statLabel: 'Procedures', stat2: '25G', stat2Label: 'Sutureless', img: serviceRetina, path: '/retina-services' },
  { num: '03', tag: 'Intraocular Pressure Control', title: 'Glaucoma Management', desc: 'Advanced imaging, micro-shunts, and selective laser trabeculoplasty to protect the optic nerve for life.', stat: '4,500+', statLabel: 'Patients managed', stat2: 'SLT', stat2Label: 'Laser therapy', img: serviceGlaucoma, path: '/glaucoma-services' },
  { num: '04', tag: 'Eyelid & Orbit Surgery', title: 'Oculoplasty Services', desc: 'Surgical correction of drooping eyelids, blocked tear ducts, and ocular reconstructive procedures.', stat: '4,000+', statLabel: 'Reconstructions', stat2: 'DCR', stat2Label: 'Lacrimal', img: serviceOculoplasty, path: '/oculoplasty-services' },
