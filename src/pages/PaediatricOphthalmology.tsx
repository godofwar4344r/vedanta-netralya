...
import { HeartHandshake, CheckCircle2, ArrowUpRight, Award, Sparkles, Shield, User, AlertTriangle, ShieldAlert } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-24">
          ...
          <div className="lg:col-span-5 relative rounded-[2.5rem] overflow-hidden shadow-2xl bg-brand-navy aspect-[4/3] border border-cream/10 flex items-center justify-center p-8">
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-cream text-2xl font-merriweather font-bold mb-2">Child-Friendly Care</h2>
              <p className="text-cream/60 text-xs font-lora max-w-sm mx-auto">
                Specialized screening using Teller cards and Snellen matching systems with full surgical backup.
              </p>
            </div>
          </div>
        </div>
