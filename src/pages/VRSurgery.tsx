...
import { Shield, CheckCircle2, ArrowUpRight, Award, Sparkles, ShieldAlert, AlertTriangle } from 'lucide-react';
      ...
      <div className="max-w-[1800px] mx-auto px-6 lg:px-16 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-24">
          ...
          <div className="lg:col-span-5 relative rounded-[2.5rem] overflow-hidden shadow-2xl bg-brand-navy aspect-[4/3] border border-cream/10 flex items-center justify-center p-8">
            <div className="absolute inset-0 bg-gradient-to-br from-brand-navy via-brand-navy/95 to-brand-teal/20 opacity-90" />
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-cream text-2xl font-merriweather font-bold mb-2">Micro-Incision MIVS</h2>
              <p className="text-cream/60 text-xs font-lora max-w-sm mx-auto">
                Sutureless 23G, 25G, and 27G vitrectomy platforms for maximum safety and rapid recovery.
              </p>
            </div>
          </div>
        </div>
