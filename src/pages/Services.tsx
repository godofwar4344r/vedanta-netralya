      ...
      <EditableContainer id="services-header">
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <p className="text-base text-brand-navy/60 font-lora">
            <EditableText id="services-description">Vedanta Netralya is a superspeciality eye hospital providing premium and comprehensive eye care including Retina, Glaucoma, Oculoplasty, Cataract, and Refractive care under the able leadership of Dr. R.J.K. Singh, Dr. Sameer Varma, and Dr. Kanhaiya Mittal.</EditableText>
          </p>
        </div>
      </EditableContainer>
