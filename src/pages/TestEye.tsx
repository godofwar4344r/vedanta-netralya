...
const TestEye: React.FC = () => {
  ...
  const snellenLines: SnellenLine[] = [
    { label: 'Big', letters: ['C', 'B', 'D'], size: 84, distValue: 'Big Size (20/100)' },
    { label: 'Small', letters: ['P', 'T', 'E', 'O', 'L', 'F'], size: 34, distValue: 'Small Size (20/40)' },
    { label: 'Ultra Small', letters: ['Z', 'O', 'C', 'E', 'F', 'L'], size: 12, distValue: 'Ultra Small Size (20/10)' }
  ];
  ...
  const getUncorrectedAcuity = () => {
    if (lensUsedAt !== null) {
      if (lensUsedAt === 0) return 'Less than Big';
      return snellenLines[lensUsedAt - 1].label;
    }
    if (lineIdx === 0 && groupStartIdx === 0) return 'Less than Big';
              ...
              <div className="flex flex-col items-center gap-6">
                ...
                <div className="bg-cream/5 border border-cream/10 rounded-2xl p-6 max-w-md w-full space-y-3 text-left">
                  ...
                  <div className="flex justify-between items-center text-xs">
                    ...
                    <strong className="text-brand-teal">Ultra Small (Restored)</strong>
                  </div>
                </div>
                ...
                <p className="text-sm text-cream/70 font-lora max-w-md leading-relaxed mt-4">
                  {lensUsedAt !== null ? (
                    ...
                    <>
                      Congratulations! You read all rows without error. Your uncorrected vision is rated at Ultra Small (Perfect).
                    </>
                  )}
                </p>
              </div>
