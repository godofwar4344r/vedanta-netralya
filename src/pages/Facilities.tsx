      ...
      <EditableContainer id="facilities-hero">
        <div className="max-w-[1800px] mx-auto px-6 lg:px-16 py-20 text-center">
          ...
          <p className="text-base text-brand-navy/60 font-lora max-w-3xl mx-auto leading-relaxed">
            <EditableText id="facilities-description">Vedanta Netralya is a newly built, fully air-conditioned super-specialty eye care centre in the Kumaun region of Uttarakhand. Equipped with two modular OTs, state-of-the-art diagnostic equipment, and 24-hour power backup.</EditableText>
          </p>
        </div>
      </EditableContainer>
