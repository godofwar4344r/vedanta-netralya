  ...
  return (
    ...
    >
      <div className="max-w-[1800px] mx-auto px-6 lg:px-16 py-20">
        <EditableSection id="doctors-header">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <p className="text-brand-teal text-[10px] tracking-[0.4em] uppercase font-black mb-4">Expert Registry</p>
            <h1 className="section-text text-brand-navy mb-6">Our Medical Experts</h1>
            <p className="text-base text-brand-navy/60 font-lora">
              Vedanta Netralya operates under the surgical leadership of highly credentialed, board-certified, and AIIMS-trained eye surgeons.
            </p>
          </div>
        </EditableSection>

        <EditableSection id="doctors-list">
              ...
              >
                <div>
                  ...
                  <div className="relative aspect-[3/4] w-full overflow-hidden bg-brand-navy-deep border-b border-cream/10">
                    ...
                    <div className="absolute bottom-6 right-6 bg-brand-teal/90 backdrop-blur-sm text-brand-navy px-4 py-2 rounded-2xl shadow-lg flex flex-col items-center">
                  ...
                  <div className="p-8 pb-4">
                    ...
                    <h2 className="text-xl font-black mt-1 font-body text-cream min-h-[3.5rem] flex items-center">{doc.name}</h2>
                      ...
                      <div className="flex gap-2.5 items-start text-xs">
                        ...
                        <div>
                          ...
                          <ul className="list-disc pl-4 text-cream/60 text-[11px] mt-1 space-y-1">
                            {doc.fellowships.map((f, i) => <li key={i}>{f}</li>)}
                          </ul>
                        </div>
                      </div>
                    </div>
        ...
        <EditableSection id="doctors-extra-team">
          <div className="max-w-4xl mx-auto bg-white border border-brand-navy/10 rounded-[2.5rem] p-8 md:p-10 shadow-lg text-brand-navy mb-20">
            ...
            <h3 className="text-2xl font-black mb-3">Consulting Surgeons & Clinical Support</h3>
